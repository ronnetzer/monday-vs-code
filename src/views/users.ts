...
export class UserProvider implements vscode.TreeDataProvider<UserItem> {
    private _onDidChangeTreeData: vscode.EventEmitter<UserItem | undefined | void> = new vscode.EventEmitter<
        UserItem | undefined | void
    >();
    ...
    getChildren(element?: unknown): Thenable<any[]> {
        if (element) {
